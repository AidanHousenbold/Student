...
print("Using integer division by 2, you can determine whether a number is even or odd. If the result it 1, the number is odd. If the result is 0, the number is even.")
