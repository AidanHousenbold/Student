 ...
 */
var dayMonth: [String: Int] = ["January": 31, "February": 28, "March": 31]
print(dayMonth)
/*:
 ...
 */
dayMonth.updateValue(29, forKey: "February")
print(dayMonth)
/*:
 Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
 */
if let key = dayMonth["January"]
{
    print("January has \(key) days")
}
